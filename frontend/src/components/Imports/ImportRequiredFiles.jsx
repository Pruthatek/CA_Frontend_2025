        ...
        const handleSubmit = async (event) => {
            ...
            try {
              const response = await axiosPrivate.post(
                '/workflow/bulk-upload/required-files/',  // <-- Adjust to your endpoint
                formData,
                {
                  headers: {
           ...
           <div className="w-full relative bg-white rounded-[8px] mt-3 p-3 border-[1.5px] border-[#E7E8EC] font-poppins ">
             ...
             <div className=' w-[50%]  px-4'>
               <div className='w-full h-[60px] border-b border-[#E7E8EC] flex items-center '>
                  <p className='font-semibold text-[18px] text-[#383a3e] '> <b style={{color: selectedColor?.bg}} className='font-bold  '>Import</b> Required Files</p>  
               </div>
...
export default ImportRequiredFiles
