...
const ClientManagement = ({
  ...
  const deleteClient = async (id) => {
    ...
    try {
      const response = await axiosPrivate.delete(
        `/workflow/client-work-category-assignment/delete/${id}/`
      );
  ...
  return (
    <div className="w-full bg-white rounded-[8px] mt-3 p-3 border-[1.5px] border-[#E7E8EC] font-poppins ">
      <p style={{ color: selectedColor?.bg }} className="font-bold text-[18px]">
        Client{" "}
        <b className="font-semibold text-[18px] text-[#383A3E] ">Management</b>
      </p>

      <div className=" flex  xl:justify-between justify-center items-center gap-3 mt-2 ">
        <div className="flex flex-row flex-wrap  gap-3">
          ...
          <div className="relative ">
            <div
              onClick={onAddClient}
              style={{ backgroundColor: selectedColor ? selectedColor.bg : "" }}
