...
const ClientInquiryForm2 = () => {
  ...
  return (
    <div className='w-full h-[80%] overflow-y-scroll no-scrollbar bg-[#F9F9FB] flex flex-col items-center font-poppins'>
        ...
        <form className='w-full my-7 px-10' onSubmit={handleSubmit}>
         ...
         <p className='mt-10 font-semibold text-[18px] text-[#1E1E1E]'>Add Reference Details</p>
          ...
          <div className='mt-5'>
            ...
            <div className='flex md:flex-row md:flex-wrap flex-col gap-y-2 gap-x-14 mt-4'>
              {/* Column 1 */}
              <div className='flex flex-col gap-y-2'>
                <label className='flex justify-between w-[250px] items-center'>
                  <div className='flex gap-x-2 items-center'>
                    <input type="checkbox" value="Accounting" onChange={handleCheckboxChange} /> Accounting
                  </div>
                  
                  <input placeholder='Price' className='w-[100px] h-[25px] border px-2 rounded-[6px] placeholder:text-[12px]  '/>
                </label>
              ...
              {/* Column 2 */}
              <div className='flex flex-col gap-y-2'>
                <label className='flex justify-between w-[300px] items-center'>
                <div className='flex gap-x-2 items-center'>
              ...
              {/* Column 3 */}
              <div className='flex flex-col gap-y-2'>
                <label className='flex justify-between w-[450px] items-center'>
                <div className='flex gap-x-2 items-center'>
...
export default ClientInquiryForm2
