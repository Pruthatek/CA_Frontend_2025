...
export default function DownloadStatus({ assignment }) {
    ...
    // };
     ...
     //      html2canvas(statusRef.current, { scale: 2, useCORS: true, }).then((canvas) => {
     ...
     //           pdf.save(`invoice_${invoce_id}.pdf`);
     //      });
     // };
...
// <div id="smallImages" 
// style={{ height: "100%", width: "30px" , backgroundImage: `url(${BASE_URL}/${item_data.product_image})` , backgroundRepeat: "no-repeat", backgroundSize: "cover" }}

//  className=" overflow-hidden  object-center Loading_images " />